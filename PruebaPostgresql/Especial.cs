...
namespace PruebaPostgresql
{
    public partial class Especial : Form
    {
        ...
        {
            dataGridView1.DataSource = ConexionPostgresql.ejecutaConsultaSelect("SELECT *FROM Especial ORDER BY idEspecial");
        }
        ...
        private void btnBorrar_Click(object sender, EventArgs e)
        {
            ...
            consulta = "UPDATE Episodio SET Estatus = False WHERE idEpisodio =  " + idEspecial.ToString(); ;
            ConexionPostgresql.ejecutaConsulta(consulta);
            MostrarDatos();
        }
